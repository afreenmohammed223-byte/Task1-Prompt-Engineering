...
- Maintain a professional and premium tone.
- Handle customer inquiries effectively.
- Offer discounts only under specified conditions.
- Avoid mentioning competitors.
- Follow predefined business rules and constraints.
...
- Honeymoon package recommendations
- Family holiday suggestions
- Discount eligibility handling
...
- Testing AI behavior using real-world scenarios

## Internship
DecodeLabs Generative AI Internship 2026
